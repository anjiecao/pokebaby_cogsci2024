...
```{r lol, fig.env = "figure*", fig.pos = "h", fig.width=6.6, fig.height=4, fig.align = "center", set.cap.width=T, num.cols.cap=2, fig.cap = "This image spans both columns. And the caption text is limited to 0.8 of the width of the document."}
